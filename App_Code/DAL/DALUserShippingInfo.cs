...
/// <summary>
/// Summary description for DALUserShippingInfo
/// </summary>
public static class DALUserShippingInfo
{
    #region Function to create
    public static long createUserShippingInfo(BLLUserShippingInfo obj)
    {
        long result = 0;
        try
        {
            ...
            param[1] = new SqlParameter("@Address", obj.Address);
            param[2] = new SqlParameter("@City", obj.City);
            param[3] = new SqlParameter("@createdBy", obj.createdBy);
            param[4] = new SqlParameter("@creationDate", obj.creationDate);                        
            param[5] = new SqlParameter("@Name", obj.Name);
            param[6] = new SqlParameter("@State", obj.State);
            param[7] = new SqlParameter("@Telephone", obj.Telephone);
            param[8] = new SqlParameter("@ZipCode", obj.ZipCode);
            param[9] = new SqlParameter("@shippingNote", obj.shippingNote);
            param[10] = new SqlParameter("@shippingCountry", obj.shippingCountry);
            param[11] = new SqlParameter("@Address2", obj.Address2);
            
            result = Convert.ToInt64(SqlHelper.ExecuteDataset(Misc.connStr, CommandType.StoredProcedure, "spCreateUserShippingInfo", param).Tables[0].Rows[0][0]);             
        }
        catch (Exception ex)
        {
            return 0;
