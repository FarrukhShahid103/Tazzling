...
public class oAuthFacebook
{
    ...
    public const string CALLBACK_URL = "http://www.tazzling.com/Default8.aspx";
    ...
    public string ConsumerKey
    {
        get
        {
            ...
            {
                _consumerKey = ConfigurationManager.AppSettings["Application_ID"].ToString(); //"160996503945227"; //Your application ID
            }
            return _consumerKey;
        }
    ...
    public string ConsumerSecret
    {
        get
        {
            ...
            {
                _consumerSecret = ConfigurationManager.AppSettings["Secret"].ToString(); //"58ea58646b233bdab01f73f843a40493"; //Your application secret
            }
