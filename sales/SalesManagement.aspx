<%@ Page Language="C#" MasterPageFile="~/sales/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="SalesManagement.aspx.cs" Inherits="sales_SalesManagement" Title="Sales Management" %>
            ...
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="SearchDiv" runat="server" >
                    <div id="search">
                        ...
                        <div>
                            <asp:TextBox ID="txtSearchFirstName" runat="server" CssClass="* Email Address"></asp:TextBox>
                        </div>
                        <div class="heading">
                ...
                <div id="SearchButtons" runat="server" class="searchButtons">
                    <div class="floatLeft">
                ...
                <div id="gv" runat="server" style="clear:both;">
