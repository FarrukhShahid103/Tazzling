...
(function (aN, D) {
    ...
    a.extend({
        ...
        attr: function (a0, aZ, a5, a8) {
            ...
            if (a0.nodeType === 1) {
                ...
                if (aZ in a0 && a1 && !a3) {
                    if (a4) {
                        if (aZ === "type" && e.test(a0.nodeName) && a0.parentNode) {
                    ...
                    if (aZ === "tabIndex") {
                        ...
                        return a7 && a7.specified ? a7.value : A.test(a0.nodeName) || k.test(a0.nodeName) && a0.href ? 0 : D;
                    }
                    return a0[aZ];
                }
    ...
    a.event = {
        add: function (a2, a6, bb, a4) {
            ...
            var bc = a7.events = a7.events || {}, a5 = a7.handle,
                a5;
            if (!a5) {
    ...
    var ah = ac.removeEventListener ? function (a0, aZ, a1) {
 ...
 */
    ...
    (function () {
        ...
        var a8 = ac.compareDocumentPosition ? function (bi, bh) {
    ...
    a.fn.extend({
        ...
        domManip: function (a5, ba, a9) {
            ...
            a0 = [],
            a4, a7;
            if (!a.support.checkClone && arguments.length === 3 && typeof a8 === "string" && m.test(a8)) {
                return this.each(function () {
    ...
    function K(a4, a2, a0) {
        ...
        if (a4.length === 1 && typeof a4[0] === "string" && a4[0].length < 512 && a5 === ac && !F.test(a4[0]) && (a.support.checkClone || !m.test(a4[0]))) {
            aZ = true;
            a1 = a.fragments[a4[0]];
            if (a1) {
                if (a1 !== 1) {
    ...
    a.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                return this.name && !this.disabled && (this.checked || p.test(this.nodeName) || aC.test(this.type));
            }).map(function (aZ, a0) {
                var a1 = a(this).val();
    ...
    a.extend({
        ...
        ajaxSettings: {
            ...
            processData: true,
            async: true,
            xhr: aN.XMLHttpRequest && (aN.location.protocol !== "file:" || !aN.ActiveXObject) ? function () {
...
(function (b) {
    function c(f) {
        var e = ["transform", "WebkitTransform", "MozTransform"];
        var g;
        while (g = e.shift()) {
            if (typeof f.style[g] != "undefined") {
                return g;
            }
        }
        return "transform";
    ...
    var a = b.fn.css;
    b.fn.css = function (e) {
        if (typeof b.props.transform == "undefined" && (e == "transform" || (typeof e == "object" && typeof e.transform != "undefined"))) {
            b.props.transform = c(this.get(0));
        }
        if (e == "transform") {
            e = b.props.transform;
        }
...
(function (e) {
    var c = "deg";
    e.fn.rotate = function (h) {
        var g = e(this).css("transform") || "none";
        if (typeof h == "undefined") {
            if (g) {
                var f = g.match(/rotate\(([^)]+)\)/);
                if (f && f[1]) {
                    return f[1];
                }
            }
        ...
        var f = h.toString().match(/^(-?\d+(\.\d+)?)(.+)?$/);
        if (f) {
            if (f[3]) {
                c = f[3];
            }
            e(this).css("transform", g.replace(/none|rotate\([^)]*\)/, "") + "rotate(" + f[1] + c + ")");
        }
    };
    e.fn.scale = function (j, i, g) {
        var h = e(this).css("transform");
        ...
        e(this).css("transform", h.replace(/none|scale\([^)]*\)/, "") + "scale(" + j + ")");
    };
    var b = e.fx.prototype.cur;
    e.fx.prototype.cur = function () {
        if (this.prop == "rotate") {
            return parseFloat(e(this.elem).rotate());
        } else {
            if (this.prop == "scale") {
                return parseFloat(e(this.elem).scale());
            }
        }
        return b.apply(this, arguments);
    };
    e.fx.step.rotate = function (f) {
        e(f.elem).rotate(f.now + c);
    };
    e.fx.step.scale = function (f) {
        e(f.elem).scale(f.now);
    };
    var a = e.fn.animate;
    e.fn.animate = function (g) {
        if (typeof g.rotate != "undefined") {
            var f = g.rotate.toString().match(/^(([+-]=)?(-?\d+(\.\d+)?))(.+)?$/);
            if (f && f[5]) {
                c = f[5];
            }
            g.rotate = f[1];
