<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tastyvoucher.aspx.cs" Inherits="tastyvoucher" %>
                ...
                <div style="clear: both; padding-left: 20px; padding-right: 20px; text-align: left;">
                    <div style="float: left; width: 45%;">
                        ...
                        <div style="clear: both; font-size: 14px; padding-top: 10px; padding-right: 10px;">
                            <asp:Label ID="lblFinePrint" runat="server" Text="• Expires August 1, 2012 • Limit 1 voucher per person • Unlimited vouchers as gifts • Appointment required • Limited quantities available • No cash back or cash value • Cannot be combined with any other offers or promotions • Taxes not included"></asp:Label>
                        </div>
                        <div style="clear: both; padding-top: 15px; font-size: 18px; font-weight: bold;">
                            <asp:Label ID="lblRedeemAtLabel" runat="server" Text="Redeem at"></asp:Label></div>
                        <div style="clear: both; font-size: 14px; padding-top: 10px; padding-right: 10px;">
                            <asp:Label ID="lblRedeemAt" runat="server" Text="604-733-7744<br>3195 Granville St<br>Vancouver, BC V6H 1S5"></asp:Label>
                        </div>
                    </div>
                    <div style="float: left; width: 45%; padding-left: 5%">
                        ...
                        <div style="clear: both;">
                            <div style="clear: both; font-size: 14px; padding-top: 10px;">
                                <asp:Label ID="lblHowToUse" runat="server" Text="• Eligible for extended health benefits - Insurance receipt available • Only 100 vouchers available! • Drug-free, hands-on, safe and effective form of healthcare • Convenient Vancouver location"></asp:Label>
                            </div>
                        </div>
