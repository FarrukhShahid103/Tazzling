<%@ Page Language="C#" MasterPageFile="~/Preview.master" AutoEventWireup="true" CodeFile="Preview.aspx.cs"
    Inherits="_Preview" Title="Untitled Page" %>
    ...
    <div style="clear: both; padding-top: 10px">
        ...
        <div class="DetailPageTopDiv" style=" background-color:White;">
            <div style="clear: both; padding-top: 7px; padding-left: 15px;">
                <div style="float: left;">
                    <span style="color:#FE9DDB; font-weight:bold;">Today's Hot Deal</span>
                </div>
            </div>
        </div>
            ...
            <div style="clear: both;">
                <div style="float: left; width: 464px;">
                    <div>
                        ...
                        <div style="clear: both; width: 100%; position: relative; height: 333px;border: 1px solid #ACAFB0; border-top:none;">
                            <asp:Literal ID="ltSlideShow" runat="server"></asp:Literal>
                        </div>
                    </div>
                    <div style="clear: both; width: 100%; padding: 10px 0px 0px 0px;">
                        <div style="border: 1px solid #ACAFB0; border-bottom: 0px none; background-color:#5f5f5f;" class="DetailTheDetailDiv">
                            <div style="clear: both; padding: 10px 0px 0px 22px; color:White;">
                                The Details
                            </div>                           
                        </div>
                    </div>
                ...
                <div style="float: left; width: 248px; padding-left: 10px;">
                    ...
                    <div class="DetailRight2ndDiv" style="border: 1px solid #ACAFB0">
                        <div style="clear: both; padding-left: 10px; padding-top: 20px;">
                            <div style="font-size: 13px; text-align:center; text-decoration:none;">
                                <a href="../howtorefer.aspx" style="text-decoration:none;"> Refer a Friend and Earn $10
                                </a>
                            </div>
                        </div>
                        <div style="clear: both; padding-left: 10px; padding-top: 10px;">
                            ...
                            <div style="float:left; padding-right: 5px; padding-left:5px; width:70px;">
                             ...
                             <div style="float: left; padding-left:5px; padding-right:5px; padding-top:2px; width:50px;">
                                <wb:share-button relateuid="2787221352" ></wb:share-button>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div style="border: 1px solid #ACAFB0; width:100%;">
                        <div class="DetailTheDetailDiv" style="background-color:#5f5f5f; color:White;">
                            <center>
                        ...
                        <div class="BusinessDetailArea">
                            <div style="clear: both; padding-left: 20px; padding-top: 20px;">
                                <div style="clear: both; font-size: 15px; font-weight: bold; color:#5f5f5f;">
                    ...
                    <div style="position: relative;">
                        ...
                        <div class="DetailRight2ndDiv shadow">
                            <div style="padding-top: 10px; padding-left: 10px; color: #2ebcf7; font-weight: bold;
                                font-size: 15px; background-color:#5f5f5f; color:White; padding-bottom:10px;">
                            ...
                            <div style="padding: 10px;">
                                <div style="float: left;">
                                    ...
                                    <div style="clear: both; width: 70px; padding-top: 5px; text-align: center; color:#5a5a5a; display:none;">
                                        <div>
