        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (Session["dtProductCart"] != null)
                {
                    ...
                    {
                        ltShoppingCart.Text = "<div style='float: left;'>";
                        for (int i = 0; i < dtProductCart.Rows.Count; i++)
                        {
                            if (Convert.ToBoolean(dtProductCart.Rows[i]["enableSize"].ToString().Trim()))
                            {
                                ltShoppingCart.Text += "<div id='div-" + dtProductCart.Rows[i]["Size"].ToString().Trim() + dtProductCart.Rows[i]["productID"].ToString().Trim() + "' style='clear: both; width: 640px; background-color:white;'><div style='clear: both; width: 640px; padding-top: 5px;'></div>";

                                ltShoppingCart.Text += "<div style='clear: both; font-size: 25px; color: black; font-weight: 700; width: 100%; padding-top: 10px;'><div style='float: left; padding-left:15px;'>";
                                if (Convert.ToBoolean(dtProductCart.Rows[i]["enableSize"].ToString().Trim()))
                                {
                                    ltShoppingCart.Text += dtProductCart.Rows[i]["title"].ToString().Trim() + "</div><div style='float: right; padding-top: 5px; padding-right:15px;' class='cartRemove' onclick='javascript:RemoveFromCartWithSize(" + dtProductCart.Rows[i]["productID"].ToString() + ",\"" + dtProductCart.Rows[i]["Size"].ToString() + "\");'>";
                                }
                                else
                                {
                                    ltShoppingCart.Text += dtProductCart.Rows[i]["title"].ToString().Trim() + "</div><div style='float: right; padding-top: 5px; padding-right:15px;' class='cartRemove' onclick='javascript:RemoveFromCart(" + dtProductCart.Rows[i]["productID"].ToString() + ");'>";
                                }

                                ltShoppingCart.Text += "</div></div>";

                                ltShoppingCart.Text += "<div style='clear: both; width: 640px; padding-top: 15px;'><div style='float: left; padding-right: 25px;'>";
                            }
                            else
                            {
                                ltShoppingCart.Text += "<div id='div-" + dtProductCart.Rows[i]["productID"].ToString().Trim() + "' style='clear: both; width: 640px; background-color:white;'><div style='clear: both; width: 640px; padding-top: 5px;'></div>";
                            ...
                            ltShoppingCart.Text += "<img src='" + dtProductCart.Rows[i]["image"].ToString().Trim() + "' width='216px' height='157px' /></div>";
                            ltShoppingCart.Text += "<div style='float: left; text-align: left; width:384px; padding-right:15px;'>";



                            ltShoppingCart.Text += "<div style='clear: both; font-size: 13px; padding-top: 10px; font-weight: 300;'><div style='width: 110px; float: left; text-align: left; color: #313131;'>";
                            ltShoppingCart.Text += "Estimated Arrival</div><div style='padding-left: 10px; float: left; text-align: left; color: #313131;'>" + dtProductCart.Rows[i]["estimatedArivalTime"].ToString().Trim() + "</div></div>";
                            ltShoppingCart.Text += "<div style='border-bottom: 1px solid #F3F3F3; width: 100%; clear: both; padding-top: 10px;'></div><div style='clear: both; font-size: 13px; padding-top: 5px; font-weight: 300;'><div style='width: 110px; float: left; text-align: left; color: #313131; vertical-align: top;'>Return Policy</div><div style='padding-left: 10px; float: left; text-align: left; color: #313131; width: 260px;'>";
                            ltShoppingCart.Text += dtProductCart.Rows[i]["returnPolicy"].ToString().Trim() + "</div></div><div style='border-bottom: 1px solid #F3F3F3; width: 100%; clear: both; padding-top: 15px;'></div>";
                            ltShoppingCart.Text += "<div style='clear: both; font-size: 13px; padding-top: 5px; font-weight: 300;'><div style='width: 110px; float: left; text-align: left; color: #313131; vertical-align: top;'>Availablity</div><div style='padding-left: 10px; float: left; text-align: left; color: #313131; width: 260px;'>";
                            ...
                            {
                                ltShoppingCart.Text += "Ship To US and Canada Only";
                            }
                            else if (Convert.ToBoolean(dtProductCart.Rows[i]["shipCanada"].ToString().Trim()))
                            {
                                ltShoppingCart.Text += "Ship To Canada Only";
                            }
                            else if (Convert.ToBoolean(dtProductCart.Rows[i]["shipUSA"].ToString().Trim()))
                            {
                                ltShoppingCart.Text += "Ship To US Only";
                            }
                            ltShoppingCart.Text += "</div></div><div style='border-bottom: 1px solid #F3F3F3; width: 100%; clear: both; padding-top: 5px;'></div><div style='clear: both; width:384px; padding-right:15px; text-align: right; padding-top: 10px; font-weight: 700;color: black; font-size: 16px;'>$";
                            ltShoppingCart.Text += Convert.ToDecimal(dtProductCart.Rows[i]["sellingPrice"].ToString()).ToString("0.###").Trim() + "</div>";
                            ltShoppingCart.Text += "<div style='clear: both; text-align: left; color: #313131; padding-top: 10px; width:384px; padding-right:15px;'><div style='float: right; font-size: 15px;'>";
                            if (Convert.ToBoolean(dtProductCart.Rows[i]["enableSize"].ToString().Trim()))
                            {
                                ltShoppingCart.Text += BindSize(dtProductCart.Rows[i]["productID"].ToString().Trim(), dtProductCart.Rows[i]["Size"].ToString().Trim(), dtProductCart.Rows[i]["Qty"].ToString().Trim());

                            }
                            else
                            {
                                ltShoppingCart.Text += BindQuantityDropDown(Convert.ToInt32(dtProductCart.Rows[i]["minQty"].ToString().Trim()), Convert.ToInt32(dtProductCart.Rows[i]["maxQty"].ToString().Trim()), Convert.ToInt32(dtProductCart.Rows[i]["Qty"].ToString().Trim()), dtProductCart.Rows[i]["productID"].ToString().Trim());
                                ltShoppingCart.Text += "</div><div style='float: right; font-size: 15px; padding-top: 3px; padding-right: 5px;padding-left: 10px;'>Quantity</div><div style='float: right; font-size: 15px;'>";
                                ltShoppingCart.Text += "";
                                ltShoppingCart.Text += "</div><div style='float: right; font-size: 15px; padding-top: 3px; padding-right: 5px;'>";
                                ltShoppingCart.Text += "";
                            }
                            ltShoppingCart.Text += "</div></div>";
                            ltShoppingCart.Text += "<div style='clear: both; width:384px; padding-right:15px; text-align: right; padding-top: 10px; font-weight: 700;color: black; font-size: 19px;'>$";
                            ltShoppingCart.Text += (Convert.ToDouble(dtProductCart.Rows[i]["sellingPrice"].ToString().Trim()) * Convert.ToDouble(dtProductCart.Rows[i]["Qty"].ToString().Trim())).ToString() + "</div></div></div><div style='clear: both; width: 640px; border-bottom: 5px solid #F3F3F3; padding-top: 15px;'></div></div>";
                        ...
                        ltShoppingCart.Text += "</div>";

                        ltShoppingCart.Text += @"<div style='float: left; padding-left: 40px;'>
                                                    <div  id='divCart' style='clear:both; position:absolute; width:317px; height:365px; background-color:white; overflow:hidden;font-size: 15px; top:253px; box-shadow: 0px 3px 0px #888888'>
