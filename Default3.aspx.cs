...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void btnBindDeals(DataTable dtDeals, string strCityName)
    {
        try
        {
            ...
            ltDealDetail.Text += "<body><center><table style=\"width: 680px; padding-top: 10px; padding-bottom: 10px;\"><tbody><tr><td>" + Server.UrlDecode(Request.QueryString["extra"].ToString().Trim()) + "</td></tr><tr><td style=\"text-align: center;\">";
            ...
            ltDealDetail.Text += "<a class=\"TopLink\" target=\"_blanck\" href=\"" + ConfigurationManager.AppSettings["YourSite"].Trim() + "/newsletter.aspx?cid=" + Request.QueryString["cid"].ToString().Trim() +
                "&date=" + Request.QueryString["date"].ToString().Trim() + "&slot=" + Request.QueryString["slot"].ToString().Trim() + "\">View this email in browser </a>";
            ...
            ltDealDetail.Text += "Daily Tastygo Deal alerts. If you prefer not to receive Daily Tastygo emails, you can always <unsubscribe>Unsubscribe</unsubscribe>.";
