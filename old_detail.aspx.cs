        ...
        if (!IsPostBack)
        {
            ...
            if (dtDeal != null && dtDeal.Rows.Count > 0)
            {
                ...
                if ((dtPosts != null) && (dtPosts.Rows.Count > 0))
                {
                    ...
                    lblCommentUserName.Text = dtPosts.Rows[0]["Name"].ToString().Trim();
                    ...
                    lblDealDiscuessionComment.ToolTip = "<b>" + dtPosts.Rows[0]["Name"].ToString().Trim() + "</b> says,<br>" + dtPosts.Rows[0]["comments"].ToString().Trim();
                    imgCommentUserImage.ToolTip = "<b>" + dtPosts.Rows[0]["Name"].ToString().Trim() + "</b><br>" + lblDealsSold2.Text.Trim() + " <br>" + lblTotalPosts.Text.Trim();
                }
                else
                {
