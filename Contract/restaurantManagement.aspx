        ...
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">
                    ...
                    <div>
                        <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/Contract/Images/btnSearch.png"
                            OnClick="btnSearch_Click" TabIndex="1" />&nbsp;<asp:ImageButton ID="btnClear" runat="server"
                                ImageUrl="~/Contract/Images/btnClear.png" OnClientClick="return clearFields();"
                                TabIndex="2" />
                    </div>
                </div>
                ...
                <div class="searchButtons">
                    <div class="floatLeft">
                        <asp:ImageButton ID="btnShowAll" runat="server" ImageUrl="~/Contract/images/btnShowAll.gif"
                    ...
                    <div class="floatLeft">
                        &nbsp;<asp:HyperLink Target="_blank" ID="btnAddNew" runat="server" ImageUrl="~/Contract/images/btnAddNew.jpg" NavigateUrl="~/Contract/addEditBusinessManagement.aspx?addNew=true" />
                    </div>
                </div>
                <div id="gv">
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="restaurantId" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="12%" HeaderText="Create Contract" HeaderStyle-HorizontalAlign="Center"
                                        ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="imgBtnAddNewDeal" runat="server" Width="41" ToolTip="Add New Contract"
                                                CausesValidation="false" ImageUrl="~/Contract/Images/restaddTofavIcon.jpg" Target="_blank" NavigateUrl='<%# "~/contract/createcontract.aspx?resId=" + Eval("restaurantId") %>' />
                                            <asp:HyperLink ID="imgBtnViewAllDeal" Visible="false" runat="server" Width="32" ToolTip="Edit Contract"
                                                CausesValidation="false" ImageUrl="~/Contract/Images/ViewAll.png" Target="_blank" NavigateUrl='<%# "~/contract/campaignManagement.aspx?Mode=All&resID=" + Eval("restaurantId") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton CommandName="Edit" ID="btnEdit" OnClientClick="return confirm('Are you sure you want to change the status of the business?')"
                                                runat="server" ImageUrl='<%#(Eval("isActive")==DBNull.Value ? "" : Convert.ToBoolean(Eval("isActive")) ? "~/Contract/images/active.png" : "~/admin/images/deactive.png") %> '
                                                ToolTip='<%#(Eval("isActive")==DBNull.Value ? "" : Convert.ToBoolean(Eval("isActive")) ? "Active" : "In Active") %> ' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Edit" Visible="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                        <asp:HyperLink ID="imgBtnEditResturants" runat="server" ToolTip="Edit Business" Visible="false"
                                                CausesValidation="false" ImageUrl="~/Contract/Images/edit.gif" Target="_blank" NavigateUrl='<%# "~/contract/addEditBusinessManagement.aspx?edit=" + Eval("restaurantId") %>' />
                                         </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Create Contract" Visible="false" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                        <asp:HyperLink ID="imgBtnCreatecontract" runat="server" ToolTip="Create Contract"
                                                CausesValidation="false" ImageUrl="~/Contract/Images/restaddTofavIcon.jpg" Target="_blank" NavigateUrl='<%# "~/contract/createcontract.aspx?resId=" + Eval("restaurantId") %>' />
