<%@ Page Language="C#" MasterPageFile="~/shipper/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="ResendOrders.aspx.cs" Inherits="ResendOrders" Title="TastyGo | shipper | Resend Orders Management" %>
                    ...
                    <div id="popup">
                        ...
                        <table border="0" cellpadding="3" cellspacing="2" width="920px" class="fontStyle">
                                ...
                                <td align="right" class="colRight">
                                    <div class="clear" style="padding-top: 15px; padding-bottom: 20px; width: 100%" align="center">
                                        <div style="float: left; padding-right: 5px">
                                            <asp:Image ID="Image1" runat="server" Visible="true" ImageUrl="~/shipper/images/error.png" />
                                        </div>
                                        <div class="floatLeft">
                            ...
                            <tr>
                                ...
                                <td align="left" class="colLeft">
                                    <asp:ImageButton ID="btnSave" runat="server" ValidationGroup="order" ImageUrl="~/shipper/Images/btnSave.jpg"
                                        Visible="True" OnClick="btnSave_Click" />
                                    <asp:ImageButton ID="CancelButton" runat="server" ImageUrl="~/shipper/Images/btnConfirmCancel.gif"
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                ...
                <div class="searchButtons">
                    <div class="floatLeft">
                        <asp:ImageButton ID="btnShowAll" runat="server" ImageUrl="~/shipper/images/btnShowAll.gif"
                            OnClick="btnShowAll_Click" />&nbsp;
                    </div>
                    <div class="floatLeft">
                        <asp:ImageButton ID="btnDeleteSelected" runat="server" ImageUrl="~/shipper/images/btnDeleteSelected.jpg"
                            OnClientClick="return preCheckSelected();" OnClick="btnDeleteSelected_Click" />
                    </div>
                    <div class="floatLeft">
                        &nbsp;<asp:ImageButton ID="btnAddNew" runat="server" ImageUrl="~/shipper/images/btnAddNew.jpg"
                            ...
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="dOrderID" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Edit" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ImageButton1" runat="server" ToolTip="Edit" CommandName="Edit" ImageUrl="~/shipper/Images/edit.gif" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Delete" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="btnDelete" runat="server" CommandName="Delete" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this record?');"
                                                ImageUrl="~/shipper/Images/delete.gif" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="lnkbtnEdit" CommandName="Edit" CommandArgument='<% # Eval("detailID") %>' runat="server" ImageUrl="~/shipper/Images/successfulorders.png" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
