<%@ Page Title="Online Deal Management" Language="C#" MasterPageFile="~/shipper/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="trackingdealManagement.aspx.cs" Inherits="trackingdealManagement"
                            ...
                            <asp:GridView ID="gvViewDeals" runat="server" DataKeyNames="productID" Width="100%"
                                ...
                                <Columns>                                                                    
                                    ...
                                    <asp:TemplateField HeaderText="Successful Orders">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlEditDeals" runat="server" Target="_blank" ToolTip="View successful orders"
                                                ...
                                                NavigateUrl='<%# "orderTracker.aspx?order=success&did="+ Eval("productID") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Refunded Orders">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlcancelorders" runat="server" Target="_blank" ToolTip="View cancel or refunded orders"
                                                ...
                                                NavigateUrl='<%# "orderTracker.aspx?order=cancel&did="+ Eval("productID") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="30px" HeaderText="Resend Orders">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlResendOrders" runat="server" Target="_blank" ToolTip="Resend orders"
                                                Text='<%#Eval("ResendOrder")%>' ForeColor="Red" NavigateUrl='<%# "ResendOrders.aspx?did="+ Eval("productID") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-Width="30px">
                                        <ItemTemplate>
                                            <asp:UpdatePanel ID="updownloadExcel" runat="server">
                                                <ContentTemplate>
                                                    <asp:ImageButton ID="imgbtnExportToExcel" runat="server" CommandArgument='<% #Eval("productID") %>'
                                                        CommandName="DownloadExcel" CausesValidation="false" ImageUrl="~/shipper/Images/download_excel.png"
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDealID" runat="server" Text='<%# DataBinder.Eval (Container.DataItem, "productID") %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
