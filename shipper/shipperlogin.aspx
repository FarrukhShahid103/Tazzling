<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shipperlogin.aspx.cs" Inherits="shipperlogin" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TastyGo | Shipper | Login</title>
    ...
    <div align="center" id="topCenter">
        <div id="container">
            <div id="headBG">
                <div id="header">
                    <div id="logo">
                        <asp:Image ID="imgLogo" runat="server" ImageUrl="~/shipper/images/logo.jpg" ToolTip="logo" /></div>
                </div>
                <div class="floatLeft">
                    ...
                    <ProgressTemplate>
                        <div class="lightbox">
                            <div style="background-color: White; padding: 20px; width: 120px; border: solid 2px #e1e1e1;">
                                <asp:Image ImageUrl="~/shipper/Images/_load.gif" ToolTip="Processing..." runat="server"
                                    ID="imgLoad" />
                                <br />
                                <br />
                                                ...
                                                <asp:Panel ID="pnlError" runat="server" Visible="False" Width="100%">
                                                    <div class="floatLeft">
                                                        <div style="float: left; padding-right: 3px">
                                                            <asp:Image ID="imgGridMessage" runat="server" Visible="true" ImageUrl="~/shipper/Images/error.png" />
                                                        </div>
                                                        <div class="floatLeft">
