<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ImportDealItems.ascx.cs"
    Inherits="Takeout_UserControls_Menu_ImportDealItems" %>
...
<h3 style="text-align: center">
    <asp:Label ID="lblDealHeader" runat="server" Text="Import Deal Menu"></asp:Label></h3>
<div class="height10">
</div>
<div class="text_right">
    <a href="../ImportTemplates/DealTemplate2003.xls" target="_blank">
        <asp:Label ID="lblTemplateFile" runat="server" Text="DealTemplate2003.xls"></asp:Label></a>
...
<RedSignal:FrameStart runat="server" ID="FrameStart1" ElementBoxId="element-box1" />
<h4 class="blue">
    <asp:Label ID="lblHeader2" runat="server" Text="Import Deal Items"></asp:Label></h4>
    ...
    <tr>
        <td colspan="3" class="buttonrow" align="center">
            ...
            <asp:ImageButton ID="btnImport" runat="server" ValidationGroup="ImportDeal" 
                ImageUrl="~/admin/Images/btnImport.gif" onclick="btnImport_Click" />
