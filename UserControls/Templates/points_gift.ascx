<%@ Control Language="C#" AutoEventWireup="true" CodeFile="points_gift.ascx.cs" Inherits="Takeout_UserControls_Templates_points_gift" %>
...
<div style="padding-top: 20px;">
    <h3 class="marginTB10 hr">
        <asp:Label ID="lblWithdrawFunds" CssClass="gcardtext" Text="Your Requested Gifts" runat="server"></asp:Label></h3>
</div>
<div>
...
<div class="gridborder">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="gridheading">
        <tr>
            <td width="15%" style="padding-left:10px;">
                <asp:Label ID="lblPonintsDate" runat="server" Text="Request Date"></asp:Label>
            </td>
            ...
            <td width="20%" style=" padding-left: 50px;">
                <asp:Label ID="lblGetsFrom" runat="server" Text="Gift Name"></asp:Label>
            </td>
            ...
            <asp:TemplateField >
                <ItemTemplate>
                    <table width="100%" border="0" cellpadding="0" cellpadding="0">
                        ...
                        <td width="20%">
                            <asp:Label runat="server" ID="lblAmount" Text='<%# Eval("mrpgPoints")%> ' ForeColor="#C75821"
                                Font-Bold="true" />
                        </td>
                        <td width="20%">
                            <asp:Label runat="server" ID="lblTypeBool" Text='<%#Eval("mrpgName") %>' />
                        </td>
                        <td width="20%">
                            <asp:Label runat="server" ID="lblDescription" Text='<%# Eval("mrpgDescription") %>' />
                        </td>
                        <td style="padding-left:20px;">
                            <asp:Label runat="server" ID="Label2" Text='<%# Eval("status") %>' />
                        </td>
                   </tr>
                    </table>
