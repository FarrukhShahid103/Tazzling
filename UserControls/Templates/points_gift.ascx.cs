...
public partial class Takeout_UserControls_Templates_points_gift : System.Web.UI.UserControl
{
    ...
    {
        objUsedPoints.createdBy = userId;
        DataTable dtWithdraw = objUsedPoints.getAllMemberPointGiftsRequestsByUserID();
