<%@ Control Language="C#" AutoEventWireup="true" CodeFile="withdraw_restaurant.ascx.cs"
    Inherits="Takeout_UserControls_Templates_withdraw_restaurant" %>
...
<div style="padding-top: 20px;">
    <h3 class="marginTB10 hr">
        <asp:Label ID="lblWithdrawFunds" Text="Withdraw Funds" runat="server"></asp:Label></h3>
</div>
...
<asp:GridView runat="server" ID="gridview1" AllowPaging="true" AllowSorting="false"
    ...
    OnPageIndexChanging="gridview1_PageIndexChanging" HorizontalAlign="Center" Width="70%"
    CssClass="gridview paddingR_0" HeaderStyle-CssClass="GridHeader" OnRowDataBound="gridview1_RowDataBound">
    <Columns>
        <asp:TemplateField>
            <HeaderTemplate>
                <asp:Label runat="server" ID="lblRequestDate" Text="Request Date"></asp:Label>
            </HeaderTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField>
            <HeaderTemplate>
                <asp:Label runat="server" ID="lblRequestStatus" Text="Request Status"></asp:Label>
            </HeaderTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField>
            <HeaderTemplate>
                <asp:Label runat="server" ID="lblRequestStatus" Text="Request Amonut"></asp:Label>
            </HeaderTemplate>
            <ItemTemplate>
                <asp:Label runat="server" ID="lblAmount" Text='<%# Eval("requestCurrencyCode") + "&nbsp;&nbsp;$" + Convert.ToDouble(Eval("requestAmount")).ToString("###.00")  %>'
