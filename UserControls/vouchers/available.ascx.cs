...
public partial class UserControls_vouchers_available : System.Web.UI.UserControl
{
        ...
        try
        {
            if (e.CommandName == "Login")
            {
                ...
                if (result)
                {
                    ...
                    imgGridMessage.ImageUrl = "~/images/Checked.png";
                    lblMessage.ForeColor = System.Drawing.Color.Black;
                    UserControls_vouchers_used used = (UserControls_vouchers_used)Page.FindControl("used1");
                    if (used != null)
                    {
