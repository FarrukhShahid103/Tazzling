<%@ Control Language="C#" AutoEventWireup="true" CodeFile="used.ascx.cs" Inherits="UserControls_vouchers_used" %>
    ...
    <div style="padding-top: 10px; width: 950px;">
            ...
            <asp:GridView runat="server" ID="gvUsed" DataKeyNames="dOrderID" AllowPaging="true"
                ...
                OnPageIndexChanging="gvUsed_PageIndexChanging" Width="950px" ShowHeader="false"
                OnRowDataBound="gvUsed_RowDataBound" OnRowCommand="gvUsed_Login">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div style="padding-bottom: 5px; padding-top: 5px;">
                                                    ...
                                                    <ItemTemplate>
                                                        <div style="padding-top: 5px;">
                                                            <div style="float: left; padding-left: 5px; padding-right: 5px; font-family: Arial;
                                                                font-size: 19px;">
                                                                <asp:Label ID="lblDetailCancelID" runat="server" Text='<%#Eval("detailID")%>' Visible="false"></asp:Label>
                                                                <%# getDealCode(Eval("dealOrderCode"),Eval("status"))%></div>
                                                            <div style="float: left; padding-left: 5px; padding-right: 5px; font-family: Arial;
                                                                font-size: 13px;">
                                                                <asp:UpdatePanel ID="upDownloadFileUsed" runat="server" UpdateMode="Conditional">
                                                                    <ContentTemplate>
                                                                        <asp:LinkButton CssClass="GridLink" ID="lbdownloadUsed" runat="server" CommandName="download"
                                                                            Visible='<%# getDetailStatus(Eval("status"))%>' CommandArgument='<%# (Eval("detailID") + "," + Eval("dOrderID"))%>'
                                                                            Text='Print in PDF' />
                                                                    </ContentTemplate>
                                                                    <Triggers>
                                                                        <asp:PostBackTrigger ControlID="lbdownloadUsed" />
                                                                    </Triggers>
                                                                </asp:UpdatePanel>
                                                            ...
                                                            <div style="float: left; padding-left: 5px; padding-right: 5px;">
                                                                <asp:Label ID="lblusedStatus" runat="server" Text='<%#Eval("markUsed")%>' Visible="false"></asp:Label>
                                                                <asp:LinkButton CssClass="GridLink" ID="lbMarkAsSoldUsed" runat="server" CommandName="Login"
                                ...
                                <div style="float: left; padding-left: 5px; padding-right: 5px; font-size: 16px;">
                                    <asp:LinkButton ID="lblUsedCancel" CssClass="GridLink" Font-Size="16px" runat="server"
                                    ...
                                    <div>
                                        <div>
                                            <div class="pagerContent" style="background-color: #04AFFF;">
                                                <asp:LinkButton ID="lnkTopUsedPrev" Enabled='<%# displayPrevious %>' CommandName="Page"
                                                    CommandArgument="Prev" runat="server" CssClass="GridLink" Text="Previous"></asp:LinkButton>
                                                <asp:Repeater ID="rptrPage" runat="server">
                                                    <ItemTemplate>
                                                        &nbsp;<asp:LinkButton ID="lnkPageUsed" CssClass="GridNumeric" OnClick="lnkPageUsed_Click"
