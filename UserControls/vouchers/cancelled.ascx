<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cancelled.ascx.cs" Inherits="UserControls_vouchers_cancelled" %>
<div style="padding-top: 10px; width: 950px;">
    ...
    <asp:GridView runat="server" ID="gvcancelled" DataKeyNames="dOrderID" AllowPaging="true"
        ...
        OnPageIndexChanging="gvcancelled_PageIndexChanging" Width="950px" ShowHeader="false"
                ...
                <ItemTemplate>
                    <div style="padding-bottom: 5px; padding-top: 5px;">
                                            ...
                                            <ItemTemplate>
                                                <div style="padding-top: 5px;">
                                                    <div style="float: left; padding-left: 5px; padding-right: 5px; font-family: Arial;
                                                        font-size: 19px;">
                                                        <asp:Label ID="lblCancelledDetailID" runat="server" Text='<%#Eval("detailID")%>' Visible="false"></asp:Label>
                                                        <%# getDealCode(Eval("dealOrderCode"),Eval("status"))%></div>
                                                    <div style="float: left; padding-left: 5px; padding-right: 5px; font-family: Arial;
                                                        font-size: 13px;">
                                                        <asp:UpdatePanel ID="upDownloadFileCancelled" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:LinkButton CssClass="GridLink" ID="lbCancelledDownlaod" runat="server" CommandName="download"
                                                                    Visible='<%# getDetailStatus(Eval("status"))%>' CommandArgument='<%# (Eval("detailID") + "," + Eval("dOrderID"))%>'
                                                                    Text='Print in PDF' />
                                                            </ContentTemplate>
                                                            <Triggers>
                                                                <asp:PostBackTrigger ControlID="lbCancelledDownlaod" />
                                                            </Triggers>
                                                        </asp:UpdatePanel>
                                                    ...
                                                    <div style="float: left; padding-left: 5px; padding-right: 5px;">
                                                        <asp:Label ID="lblCancelledStatus" runat="server" Text='<%#Eval("markUsed")%>' Visible="false"></asp:Label>
                                                        <asp:LinkButton CssClass="GridLink" ID="lbMarkAsSoldcancelled" runat="server" CommandName="Login"
                        ...
                        <div style="float: left; padding-left: 5px; padding-right: 5px; font-size: 16px;">
                            <asp:LinkButton ID="lblCancelCan" CssClass="GridLink" Font-Size="16px" runat="server"
                            ...
                            <div>
                                <div>
                                    <div class="pagerContent" style="background-color: #04AFFF;">
                                        <asp:LinkButton ID="lnkTopCacellPrev" Enabled='<%# displayPrevious %>' CommandName="Page"
                                            CommandArgument="Prev" runat="server" CssClass="GridLink" Text="Previous"></asp:LinkButton>
                                        <asp:Repeater ID="rptrPage" runat="server">
                                            <ItemTemplate>
                                                &nbsp;<asp:LinkButton ID="lnkCancellPage" CssClass="GridNumeric" OnClick="lnkCancellPage_Click"
                                        ...
                                        <asp:LinkButton ID="lnkTopCancelNext" runat="server" Enabled='<%# displayNext %>' CommandName="Page"
