<%@ Page Title="Affiliate Area" Language="C#" MasterPageFile="~/tastyGo.master" AutoEventWireup="true" CodeFile="MemberAffiliate.aspx.cs" Inherits="MemberAffiliate" %>
                ...
                <div>
                    ...
                    <div style="clear: both; padding-top: 10px; margin-bottom: 10px;">
                       <%-- <div class="DetailPageTopDiv">
                        ...
                        <div class="PageHeading"> My <span style="color:#DD0016;">Affiliate Area</span></div>
                    </div>
                </div>
                <div style="background-color: White; min-height: 450px; margin-top:27px;">
                                ...
                                <div style="height: auto; overflow: hidden;">
                                    <div style="text-align: left; overflow: hidden; height: auto; width: 100%; background: #E6E6E5">
                                        <div style="padding-left: 15px;">
                                            ...
                                            <div style="float: left; margin-left: 10px; padding-top: 27px;">
                                                <asp:Button runat="server"  BackColor="#DD0016" ID="btnSelect" style="background-image:url(Images/show-record.png); width:106px; height:31px; border:none; cursor:pointer"
                                ...
                                <div align="center">
                                    <div style="background-color:#E6E6E5; height:50px;margin-top:5px;">
                                        ...
                                        <div style="padding-top: 8px;">
                                            If you have any questions regarding the affiliate area, please contact us at <a style="color: #DD0016;
                                                font-weight: bold; text-decoration: none;">1855-295-1771</a> or email at <a style="color: #DD0016;
