        ...
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">
                    ...
                    <div>
                        <asp:TextBox ID="txtSearchCardNumber" runat="server" CssClass="txtSearch"></asp:TextBox>
                    </div>
                    <div>
                ...
                <div id="gv">
                    ...
                    <asp:UpdatePanel ID="gvUpdatepannel" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="cardID" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" value='<% # Eval("cardID") %>' ID="RowLevelCheckBox"
                                                onclick="ChangeHeaderAsNeeded()" />
                                            <div style="display: none">
                                                <asp:Label ID="lblID1" runat="server" Text='<% # Eval("cardID") %>' Visible="true"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                        <ItemStyle Width="2%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="13%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblCousineHeadcardID" ForeColor="White" runat="server" Text="Card ID"
                                                CommandName="Sort" CommandArgument="cardID"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblcardIDText" Text='<% # Eval("cardID") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="18%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblCardHeadCardAmount" ForeColor="White" runat="server" Text="Card Amount"
                                                CommandName="Sort" CommandArgument="cardAmount"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblCardAmountText" Text='<% # Eval("cardAmount") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblCardHeadCardImage" ForeColor="White" runat="server" Text="Card Image"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Image ID="imgCardImage" runat="server" Height="50px" Width="82px" ImageUrl='<% # "~/Images/GiftCard/" + Eval("cardImage") %>' />
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <table border="0" cellpadding="3" cellspacing="2" width="920px" class="fontStyle">
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="lblUserType" runat="server" Text="Card Amount" />
                                </td>
                                <td align="left" class="colLeft">
                                    ...
                                    <cc1:RangeValidator ID="rngItemPriceRange" SetFocusOnError="true" runat="server"
                                        ControlToValidate="txtCardAmount" Type="Currency" MinimumValue="0" MaximumValue="999999999"
                            ...
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="Label1" runat="server" Text="Card Image" />
                                </td>
                                <td align="left" class="colLeft">
