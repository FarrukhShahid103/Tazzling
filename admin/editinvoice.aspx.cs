    ...
    protected void renderFirstDealInvoice()
    {
        try
        {
                ...
                && Convert.ToBoolean(dtResult.Rows[0]["paymentDone"].ToString().Trim()))
            {
                ...
                lblLablePayments.Text = "First Payment sent on " + dtPaymentDate.ToString("MM/dd/yyyy");
            }
...
//            strQuery += ",isnull((SELECT sum(qty) FROM  [dealOrders] where [dealOrders].dealId= [deals].dealId  and dealOrders.status='Successful'),0) 'SuccessfulOrders'";
            ...
            for (i = 0; i < dtDealDetail.Rows.Count; i++)
            {
                ...
                {
                    tempRefunded = Convert.ToDouble(dtDealDetail.Rows[i]["sellingPrice"].ToString().Trim()) * Convert.ToDouble(dtDealDetail.Rows[i]["CancelOrders"].ToString().Trim());
                    double tempAdveriseFee = (Convert.ToDouble(dtDealDetail.Rows[i]["OurCommission"].ToString().Trim()) / 100) * tempRefunded;
                    ...
                    {
                        tempccTransactionFee = (3.9 / 100) * tempRefunded;
                    }
                    double tempTax = (12.00 / 100) * tempAdveriseFee;
            ...
            if (shippingTaxDealExist)
            {
                ...
                if (dtpayout != null && dtpayout.Rows.Count > 0)
                {
                    ...
                    if (dtpayout.Rows.Count % 2 == 0)
                    {
                        ...
                        ltAdjustmentTotal.Text += "$" + Math.Round((dTotalPayoutToBusiness + dTotalAdjustment), 2, MidpointRounding.AwayFromZero) + "</div></div>";
                    }
                    else
                    {
            ...
            txtFirstPaymentDateTime.Text = "10 Business Days After Deal Ends";
            txtFirstPaymentPer.Text = "30";
            ...
            hfTotalPaymout.Value = dTotalPayoutToBusiness.ToString();
            ViewState["dTotalPayoutToBusiness"] = dTotalPayoutToBusiness;
            //SecondPayment            
            lblSecondPaymentDateTime.Text = "50 Business Days After Deal Ends";
            txtSecondPaymentDateTime.Text = "50 Business Days After Deal Ends";
            txtSecondPaymentPer.Text = "50";
            ...
            txtThirdPaymentDateTime.Text = "90 Business Days After Deal Ends";

            txtThirdPaymentPercent.Text = "20";
    ...
    protected void btnSendFistPayment_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (dAmountPercent == 100)
            {
                ...
                string strTempInsertQuerty = "update businessInvoiceInfo set paymentDone=1, paymentdate='" + DateTime.Now + "', paymentAmount='" + lblFirstPaymentAmount.Text.Trim().Replace("$", "") + "', paymentSend='" + lblFirstPaymentAmount.Text.Trim().Replace("$", "") + "', modifiedDate='" + DateTime.Now + "', modifiedBy='" + ViewState["userID"].ToString().Trim() + "' where dealID='" + Request.QueryString["did"].Trim() + "' and invoiceType='" + Request.QueryString["invoicetype"].Trim() + "'";

                strTempInsertQuerty += " insert into businessInvoiceInfo (bName ,bAddress ,bPhone ,cName ,cAddress ,cPhone ,firstPer ,secondPer ,thirdPer ,dealID ,invoiceType ,createdDate ,createdBy,firstPaymentText,secondPaymentText,thirdPaymenText,paymentAmount) Values ('" + lblBusinessName.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessAddress.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPhone.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPaymentTitle.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPaymentAddress.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPaymentPhone.Text.Trim().Replace("'", "''") + "' ,'" + lblFirstPaymentPer.Text.Trim().Replace("'", "''") + "' ,'" + lblSecondPaymentPer.Text.Trim().Replace("'", "''") + "' ,'" + lblThirdPaymentPercent.Text.Trim().Replace("'", "''") + "' ,'" + Request.QueryString["did"].Trim() + "' ,'2nd' ,'" + DateTime.Now + "' ,'" + ViewState["userID"].ToString().Trim() + "' ,'" + lblFirstPaymentDateTime.Text.Trim().Replace("'", "''") + "'  ,'" + lblSecondPaymentDateTime.Text.Trim().Replace("'", "''") + "'  ,'" + lblThirdPaymentDateTime.Text.Trim().Replace("'", "''") + "','" + lblSecondPaymentAmount.Text.Trim().Replace("$", "") + "')";
                strTempInsertQuerty += " insert into businessInvoiceInfo (bName ,bAddress ,bPhone ,cName ,cAddress ,cPhone ,firstPer ,secondPer ,thirdPer ,dealID ,invoiceType ,createdDate ,createdBy,firstPaymentText,secondPaymentText,thirdPaymenText,paymentAmount) Values ('" + lblBusinessName.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessAddress.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPhone.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPaymentTitle.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPaymentAddress.Text.Trim().Replace("'", "''") + "' ,'" + lblBusinessPaymentPhone.Text.Trim().Replace("'", "''") + "' ,'" + lblFirstPaymentPer.Text.Trim().Replace("'", "''") + "' ,'" + lblSecondPaymentPer.Text.Trim().Replace("'", "''") + "' ,'" + lblThirdPaymentPercent.Text.Trim().Replace("'", "''") + "' ,'" + Request.QueryString["did"].Trim() + "' ,'3rd' ,'" + DateTime.Now + "' ,'" + ViewState["userID"].ToString().Trim() + "' ,'" + lblFirstPaymentDateTime.Text.Trim().Replace("'", "''") + "'  ,'" + lblSecondPaymentDateTime.Text.Trim().Replace("'", "''") + "'  ,'" + lblThirdPaymentDateTime.Text.Trim().Replace("'", "''") + "','" + lblThirdPaymentAmount.Text.Trim().Replace("$", "") + "')";
                SqlHelper.ExecuteNonQuery(Misc.connStr, CommandType.Text, strTempInsertQuerty);                
                lblLablePayments.Text = "First Payment sent on " + DateTime.Now.ToString("MM/dd/yyyy");
    ...
    protected void btnSaveRefund_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            try
            {
                ...
                string url = ConfigurationManager.AppSettings["YourSite"] + "/admin/refundinvoice.aspx?did=" + Request.QueryString["did"].Trim() + "&pdfdownload=true&myname=" + Request.QueryString["myname"].Trim() + "&invoicetype=" + Request.QueryString["invoicetype"].Trim();
                Process PDFProcess = new Process();
        ...
        try
        {
            ...
            if (dAmountPercent == 100)
            {
                try
                {
                    ...
                    string url = ConfigurationManager.AppSettings["YourSite"] + "/admin/invoice.aspx?did=" + Request.QueryString["did"].Trim() + "&pdfdownload=true&myname=" + Request.QueryString["myname"].Trim() + "&invoicetype=" + Request.QueryString["invoicetype"].Trim();
                    Process PDFProcess = new Process();
