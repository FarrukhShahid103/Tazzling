...
//            obj.categoryId = Convert.ToInt64(pageGrid.SelectedDataKey.Value);
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            strQuery = "SELECT categoryId ,categoryDescription ,categoryName,categoryParentID";
			strQuery +=" ,status,creationDate,createdBy ,modifiedDate ,modifiedBy FROM categories where categoryParentID=0 ";            
    ...
    protected void pageGrid_Updating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            obj.categoryId = Convert.ToInt32(pageGrid.DataKeys[e.RowIndex].Value);
            ClearFields();
            ddlCategories.SelectedValue = obj.categoryId.ToString();
