<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="pointGiftRequests.aspx.cs" Inherits="pointGiftRequests"
    Title="TastyGo | Admin | Point Gift Requests" %>
            ...
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                ...
                <div id="gv">
                    ...
                    <asp:UpdatePanel ID="gvUpdatepannel" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="mrpgID" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" value='<% # Eval("mrpgID") %>' ID="RowLevelCheckBox"
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblID1" runat="server" Text='<% # Eval("mrpgID") %>' Visible="true"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="2%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <div style="padding-left: 12px;">
                                                <asp:LinkButton ID="lblUserHeadFName" ForeColor="White" runat="server" Text="User Name"
                                                    CommandName="Sort" CommandArgument="userName"></asp:LinkButton>
                                            </div>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div style="padding-left: 12px;">
                                                <asp:Label ID="lblUserFirstNameText" Text='<% # Eval("userName") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" SortExpression="lastName"
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblUserHeadLName" ForeColor="White" runat="server" Text="Gift Name"
                                                CommandName="Sort" CommandArgument="mrpgName"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblUserLastNameText" Text='<% # Eval("mrpgName") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="35%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblUserHeadUName" ForeColor="White" runat="server" Text="Description"
                                                CommandName="Sort" CommandArgument="mrpgDescription"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblUserUserNameText" Text='<% # Eval("mrpgDescription") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblFoodCreditHead" ForeColor="White" runat="server" Text="Points"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblUsermrpgPointsText" Text='<% # Eval("mrpgPoints") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblUserHeadStatus" ForeColor="White" runat="server" Text="Status"
                                    ...
                                    <asp:TemplateField HeaderText="Select Status" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <asp:ListItem Value="Decline">Decline</asp:ListItem>
                                         ...
                                         <cc1:RequiredFieldValidator ID="rfvFoodCredit" runat="server" ControlToValidate="ddlStatus"
                                        InitialValue="Select" Display="None" SetFocusOnError="true" ErrorMessage="Select Status!"
                                        ValidationGroup='<% # "user"+Eval("mrpgID") %>'></cc1:RequiredFieldValidator>
                                        
                                           <%-- <cc1:RequiredFieldValidator ID="rfvFoodCredit" SetFocusOnError="true" runat="server"
                                                ControlToValidate="txtFoodCredit" ValidationGroup='<% # "user"+Eval("mrpgID") %>'
                                    ...
                                    <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ibLogin" CommandName="Edit" ValidationGroup='<% # "user"+Eval("mrpgID") %>'
