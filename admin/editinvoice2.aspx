<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editinvoice2.aspx.cs" Inherits="editinvoice2" %>
                ...
                <div style="clear: both; padding-top: 40px;">
                    ...
                    <div style="width: 100%; clear: both; font-size: 16px; padding-top: 10px; padding-left: 15px;">
                        <div style="float: left; padding-left: 15px;">
                            <asp:ImageButton ID="btnSendFistPayment" runat="server" ImageUrl="~/admin/Images/BtnSendSecondPayment.png"
