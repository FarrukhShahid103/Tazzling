...
public partial class dealInvoice : System.Web.UI.Page
{
    ...
    private DataSet SearchQuery(string strRowIndex)
    {
        ...
        try
        {
            ...
            if (ddlSearchPayment.SelectedIndex != 0)
            {
                strQuery += " and dealpayment = "+ ddlSearchPayment.SelectedIndex.ToString();
            }
        ...
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                    ...
                    && Convert.ToInt32(hfdealpayment.Value.Trim()) > 0)
                {
                    ...
                    else if (hfdealpayment.Value.Trim() == "4")
                    {
