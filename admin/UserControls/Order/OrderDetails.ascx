<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderDetails.ascx.cs"
    Inherits="admin_UserControls_Order_OrderDetails" %>
<div class="height10">
</div>
<div id="search">
...
<div class="indent30">
    <table cellpadding="3" cellspacing="7" width="100%" border="0" class="fontStyle">
        <tr>
            <td width="141px" align="left" class="colLeftOrderDetail">
                <asp:Label ID="lblOrder" runat="server" Font-Bold="true" Text="Deal Title:"></asp:Label>
            </td>
            <td align="left">
         ...
         <tr>
            <td align="left">
                <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Business Name:"></asp:Label>
            </td>
            <td align="left">
...
<div class="indent30">
    <table cellpadding="3" cellspacing="7" width="100%" border="0" class="fontStyle">
        ...
        <tr id="trGift" runat="server" visible="false">
            <td style='float: left; width: 300px;'>
                <asp:Label ID="Label3" runat="server" Text="Deal For Gift"></asp:Label>
            </td>
            <td style='float: left; width: 150px;'>
                <asp:Label ID="lblGiftQty" runat="server" Text=""></asp:Label>
            </td>
            <td style='float: left; width: 150px;'>
                <asp:Label ID="lblGiftUnitPrice" runat="server" Text=""></asp:Label>
            </td>
            <td style='float: left; width: 150px;'>
                <strong>
                    <asp:Label ID="lblGiftTotal" runat="server" Text=""></asp:Label></strong>
            </td>
        </tr>
        <tr>
