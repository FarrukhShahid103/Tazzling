<%@ Page Title="TastyGo | Admin | Points Gift" Language="C#" MasterPageFile="~/admin/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="pointgift.aspx.cs" Inherits="pointgift" %>
...
<script type="text/javascript" language="javascript">
        function clearFields() {
            ...
            document.getElementById('ctl00_ContentPlaceHolder1_txtSearchGiftName').value = '';
            return false;
        }
    ...
    <asp:UpdatePanel ID="upGrid" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">
                    <div class="heading">
                        <asp:Label ID="lblCousineNameSearch" runat="server" Text="Gift Name"></asp:Label>
                    </div>
                    <div>
                        <asp:TextBox ID="txtSearchGiftName" runat="server" CssClass="txtSearch"></asp:TextBox>
                    </div>
                    <div class="heading">
                ...
                <div id="gv">
                    ...
                    <asp:UpdatePanel ID="gvUpdatepannel" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="pgID" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" value='<% # Eval("pgID") %>' ID="RowLevelCheckBox"
                                                onclick="ChangeHeaderAsNeeded()" />
                                            <div style="display: none">
                                                <asp:Label ID="lblID1" runat="server" Text='<% # Eval("pgID") %>' Visible="true"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                        <ItemStyle Width="2%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="13%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblCousineHeadcardID" ForeColor="White" runat="server" Text="Gift Name"
                                                CommandName="Sort" CommandArgument="pgName"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblcardIDText" Text='<% # Eval("pgName") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="18%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblCardHeadCardAmount" ForeColor="White" runat="server" Text="Points Required"
                                                CommandName="Sort" CommandArgument="pgPoints"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblCardAmountText" Text='<% # Eval("pgPoints") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField ItemStyle-Width="18%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblCardHeadpgDescription" ForeColor="White" runat="server" Text="Description"
                                                CommandName="Sort" CommandArgument="pgDescription"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblpgDescriptionText" Text='<% # Eval("pgDescription") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblCardHeadCardImage" ForeColor="White" runat="server" Text="Gift Image"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Image ID="imgCardImage" runat="server" Height="50px" Width="82px" ImageUrl='<% # "~/Images/GiftCard/" + Eval("pgImage") %>' />
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div id="popup">
                        <div id="popHeader">
                            <div style="float: left">
                                <asp:Label ID="lblpopHead" Text="Gift Cards" runat="server"></asp:Label>
                            </div>
                        </div>
                        <table border="0" cellpadding="3" cellspacing="2" width="920px" class="fontStyle">
                        <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="Label2" runat="server" Text="Gift Name" />
                                </td>
                                <td align="left" class="colLeft">
                                    <asp:TextBox ID="txtGiftName" runat="server" CssClass="txtForm"></asp:TextBox>
                                    <cc1:RequiredFieldValidator ID="RequiredFieldValidator2" SetFocusOnError="true" runat="server"
                                        ControlToValidate="txtGiftName" ErrorMessage="Gift name required!" ValidationGroup="Card"
                                        Display="None">                            
                            ...
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="lblUserType" runat="server" Text="Require Points" />
                                </td>
                                <td align="left" class="colLeft">
                                    <asp:TextBox ID="txtCardAmount" runat="server" CssClass="txtForm"></asp:TextBox>
                                    ...
                                    <cc2:ValidatorCalloutExtender ID="vcdCousineName" runat="server" TargetControlID="rfvCardAmount">
                                    </cc2:ValidatorCalloutExtender>
                                    <cc1:RangeValidator ID="rngItemPriceRange" SetFocusOnError="true" runat="server"
                                        ControlToValidate="txtCardAmount" Type="Integer" MinimumValue="0" MaximumValue="999999999"
                                        ErrorMessage="Numeric value required!" ValidationGroup="Card" Display="None">                            
                                    </cc1:RangeValidator>
                            ...
                            <tr>
                                ...
                                <td align="left" class="colLeft" >
                                    <asp:TextBox ID="txtDescription" TextMode="MultiLine" Height="100px" runat="server" CssClass="txtForm"></asp:TextBox>
                                    <cc1:RequiredFieldValidator ID="RequiredFieldValidator3" SetFocusOnError="true" runat="server"
                                        ControlToValidate="txtDescription" ErrorMessage="Description required!" ValidationGroup="Card"
                                        Display="None">                            
                                    </cc1:RequiredFieldValidator>
                            ...
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="Label1" runat="server" Text="Gift Image" />
                                </td>
                                <td align="left" class="colLeft">
                                    <asp:UpdatePanel ID="upImage" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                        <ContentTemplate>
                                            <div>
                                                <asp:FileUpload ID="fuGiftcardImage" runat="server" />
                                                <cc1:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="ImageValidation"
                                                    ControlToValidate="fuGiftcardImage" Display="None" ValidationGroup="Card" ErrorMessage="Invalid file format."
                                                ...
                                                <cc1:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" runat="server"
                                                    ControlToValidate="fuGiftcardImage" ErrorMessage="Card image required!" ValidationGroup="Card"
                                                    Display="None">                            
                                                </cc1:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td align="left" class="colLeft">
                                    <asp:ImageButton ID="btnSave" runat="server" ValidationGroup="Card" ImageUrl="~/admin/images/btnSave.jpg"
                                        OnClick="btnSave_Click" />
                                    <asp:ImageButton ID="btnUpdate" runat="server" ValidationGroup="Card" ImageUrl="~/admin/images/btnUpdate.jpg"
