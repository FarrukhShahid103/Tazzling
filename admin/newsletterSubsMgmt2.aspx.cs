...
public partial class admin_newsletterSubsMgmt2 : System.Web.UI.Page
{
    ...
    private bool AddNewSubscriberEmail()
    {
        ...
        try
        {            
            string[] strSubscrList = txtSubscriberEmail.Text.Trim().Replace(',', ';').Replace('*',';').Split(';');
            for (int i = 0; i < strSubscrList.Length; i++)
            {
                if (strSubscrList[i].ToString().Trim() != "")
                {
                    Misc.addSubscriberEmailForAdmin(strSubscrList[i].ToString().Trim(), this.ddlSelectCity.SelectedValue.ToString().Trim());
                }
            }
    ...
    private bool UpdateSubscriberEmail()
    {
        ...
        try
        {
            ...
            obj.Email = this.txtSubscriberEmail.Text.Trim().Replace(",","").Replace(";", "");
            ...
            if (dtEmail != null && dtEmail.Rows.Count == 0)
            {
                ...
                objBLLNewsLetterSubscriber.Email = this.txtSubscriberEmail.Text.Trim().Replace(",", "").Replace(";", "");
                objBLLNewsLetterSubscriber.CityId = int.Parse(this.ddlSelectCity.SelectedValue.ToString().Trim());
