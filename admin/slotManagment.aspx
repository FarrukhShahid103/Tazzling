<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="slotManagment.aspx.cs" Inherits="slotManagment" Title="Slot Managment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function changeFeaturedStatus(id) {            
            ...
            $.ajax({
                type: 'POST',
                url: '../getStateLocalTime.aspx?isFeaturedCampaign=' + id+'&isFeatured='+val,
        ...
        function pageLoad() {
            ...
            $("#test-list").sortable({
                ...
                update: function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../getStateLocalTime.aspx?slotCampaign=" + order,
