<%@ Page Title="TastyGo | Admin | Category Management" Language="C#" MasterPageFile="~/admin/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="categoriesManagement.aspx.cs" Inherits="categoriesManagement" %>
    ...
    <asp:UpdatePanel ID="upGrid" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">
                    <div class="heading">
                        <asp:Label ID="lblCousineNameSearch" runat="server" Text="Category Name"></asp:Label>
                    </div>
                    <div>
                    ...
                    <asp:UpdatePanel ID="gvUpdatepannel" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="categoryId" Width="100%"
                                AutoGenerateColumns="False" AllowPaging="True" OnRowUpdating="pageGrid_Updating" OnPageIndexChanging="pageGrid_PageIndexChanging"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblcategoryviewSubHead" ForeColor="White" runat="server" Text="View Subcategories"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:HyperLink ID="hlView" runat="server" ImageUrl="~/admin/Images/view_icon.gif"
                                                    NavigateUrl='<% # "~/admin/subcategoriesManagement.aspx?vscid="+Eval("categoryId") %>' />
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblcategoryAddNewHead" ForeColor="White" runat="server" Text="Add New Subcategory"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                            <asp:ImageButton ID="ibAddNew" runat="server" CommandName="Update" ImageUrl="~/admin/Images/add-2-icon.png" />
                                                <%--<asp:HyperLink ID="hlAddNew" runat="server" ImageUrl="~/admin/Images/add-2-icon.png"
                                                    NavigateUrl='<% # "~/admin/categoriesManagement.aspx?ascid="+Eval("categoryId") %>' />--%>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                    ...
                    <div id="popup">
                        ...
                        <table border="0" cellpadding="3" cellspacing="2" width="920px" class="fontStyle">
                            ...
                            <tr>
                                ...
                                <td align="left" class="colLeft">
                                    <asp:CheckBox ID="cbStatus" Checked="true" runat="server" Text="" />
                                </td>
                            </tr>
                            <tr>
