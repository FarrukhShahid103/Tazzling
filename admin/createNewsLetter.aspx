<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="createNewsLetter.aspx.cs" Inherits="createNewsLetter" Title="Create News Letter" %>
                    ...
                    <div id="searchBig">
                        <div style="clear: both;">
                            ...
                            <div style="float: left; padding-left: 10px; ">
                                <asp:DropDownList ID="ddlSearchCity" runat="server" AutoPostBack="true" 
                                    Width="192px">
                        ...
                        <div style="clear: both; padding-top: 8px;">
                            <div style="float: left;">
                                <div style="float: left;">
                                    <asp:Label ID="lbldlStartTime" runat="server" style="font-family:'Museo Sans 500'" Text="Select Time"></asp:Label>
                                </div>
