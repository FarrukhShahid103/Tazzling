<%@ Page Title="TastyGo | Admin | Menu Items" Language="C#" MasterPageFile="~/admin/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="adddealtems.aspx.cs" Inherits="adddealtems" %>

<%@ Register Assembly="Validators" Namespace="Sample.Web.UI.Compatibility" TagPrefix="cc1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<%@ Register Src="~/UserControls/Templates/FrameStart.ascx" TagName="FrameStart" TagPrefix="uc1" %>
<%@ Register Src="~/UserControls/Templates/FrameEnd.ascx" TagName="FrameEnd" TagPrefix="uc2" %>
...
function MyAlert(Type,Body)
{
if (Type=='error')
{
csscody.error('<br><div id="Success" style="margin-left:50px;"><h1>' + Body + "</h1></Div><br>");
}
else if (Type=='alert')
{
csscody.alert('<br><div id="Success" style="margin-left:50px;"><h1>' + Body + "</h1></Div><br>");

}
else if (Type=='success')
{
csscody.success('<br><div id="Success" style="margin-left:50px;"><h1>' + Body + "</h1></Div><br>");
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showDelConfirmBox(intID) {
            document.getElementById('ctl00_ContentPlaceHolder1_hidFoodTypeId').value = intID;
            document.getElementById('confirmationBoxBackGround').style.display = 'block';
            document.getElementById('ctl00_ContentPlaceHolder1_pnlDelete').style.display = 'block';
            return false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="upMain" runat="server">
        <ContentTemplate>
            <div id="confirmationBoxBackGround">
                <div id="confirmBox">
                </div>
            </div>
            <asp:Panel ID="pnlDelete" runat="server" CssClass="confirmationStyle">
                <div class="headingStripConfirm">
                    ...
                    <div class="floatRight" style="padding-right: 4px;">
                        <asp:LinkButton ID="lbClose" ForeColor="White" Style="text-decoration: none; outline: none"
                            runat="server" Text="[ X ]" OnClientClick="document.getElementById('confirmationBoxBackGround').style.display='none'; document.getElementById('ctl00_ContentPlaceHolder1_pnlDelete').style.display='none'; return false;"></asp:LinkButton>
                    </div>
                </div>
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <asp:UpdatePanel ID="upImageEdit" runat="server">
                                    <ContentTemplate>
                            ...
                            <td style="padding-left: 12px;">
                                <asp:ImageButton ID="btnChange" runat="server" ValidationGroup="change" ImageUrl="~/admin/Images/btnSave.jpg"
            ...
            <asp:Panel ID="pnlForm" runat="server" Visible="true">
                <div id="popHeader">
                    <div style="float: left">
                        <asp:Label ID="lblpopHead" Text="Custom Type of Food" runat="server"></asp:Label></div>
                </div>
                ...
                <div class="floatLeft">
                    ...
                    <ItemTemplate>
                        <img id="image_" runat="server" width="16" alt="" src="images/expand.gif" height="16">
                    </ItemTemplate>
                </asp:TemplateColumn>--%>
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                                            ...
                                                            <td class="foodimage" align="left">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0)" id="ImageButton2" style="outline: none; text-decoration: none"
                                                                        onclick='showDelConfirmBox("<%# Eval("dealImage") %>");'>
                                                                                ...
                                                                                <asp:DataGrid ID="gridViewItems" runat="server" AllowPaging="False" AllowSorting="False"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateColumn HeaderText="Action">
                                                                                            <FooterTemplate>
                                                                                                <asp:ImageButton ID="btnAddMenuItem" CommandName="AddItem" CommandArgument='<%# DataBinder.Eval (Container.DataItem, "dealID") %>'
                                                                                                    runat="server" ImageUrl="~/admin/Images/btnAddNew.jpg"></asp:ImageButton>
                                                                                            </FooterTemplate>
                                                                                            <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <cc1:RequiredFieldValidator ID="rfvTypeOfFood" runat="server" ControlToValidate="txtTypeofFood"
                                                    ErrorMessage="Deal name required" ValidationGroup="food" Display="None" SetFocusOnError="true"></cc1:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <cc1:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtQuantity"
                                                    ErrorMessage="Order Qty. required" ValidationGroup="food" Display="None" SetFocusOnError="true"></cc1:RequiredFieldValidator>
                                                <cc2:ValidatorCalloutExtender runat="server" ID="ValidatorCalloutExtender3" TargetControlID="RequiredFieldValidator2">
                                                </cc2:ValidatorCalloutExtender>
                                                <cc1:RangeValidator runat="server" ID="RangeValidator2" ValidationGroup="food" Type="Integer"
                                            ...
                                            <td align="left">
                                                ...
                                                <cc1:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDealPrice"
                                                    ErrorMessage="Price required" ValidationGroup="food" Display="None" SetFocusOnError="true"></cc1:RequiredFieldValidator>
                                                <cc2:ValidatorCalloutExtender runat="server" ID="ValidatorCalloutExtender4" TargetControlID="RequiredFieldValidator3">
                                                </cc2:ValidatorCalloutExtender>
                                                <cc1:RangeValidator runat="server" ID="RangeValidator1" ValidationGroup="food" Type="Currency"
