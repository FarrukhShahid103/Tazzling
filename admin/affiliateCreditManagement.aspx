<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true" CodeFile="affiliateCreditManagement.aspx.cs" Inherits="admin_affiliateCreditManagement" Title="TastyGo | Admin | Affiliate Partner Credit Management" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function clearFields() {
            ...
            document.getElementById('ctl00_ContentPlaceHolder1_txtAffCredit').value = '';
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">
                    ...
                    <div>
                        <asp:TextBox ID="txtSearchUserName" runat="server" Width="72px" CssClass="txtSearch"></asp:TextBox>
                    </div>
                    <div class="heading">
                        <asp:Label ID="Label1" runat="server" Text="Affiliate Credit"></asp:Label>
                    </div>
                    <div>
                        <asp:DropDownList ID="ddlAffCredit" Height="24" Font-Size="11pt" runat="server">
                    ...
                    <div>
                        <asp:TextBox ID="txtAffCredit" Width="63px" runat="server" CssClass="txtSearch"></asp:TextBox></div>
                    <div>
                ...
                <div class="searchButtons">
                    <div class="floatLeft">
                        <asp:ImageButton ID="btnShowAll" runat="server" CausesValidation="false" ImageUrl="~/admin/images/btnShowAll.gif"
                            OnClick="btnShowAll_Click" />&nbsp;
                    </div>
                    <div class="floatLeft">
                        <asp:ImageButton Visible="false" ID="btnDeleteSelected" runat="server" CausesValidation="false" ImageUrl="~/admin/images/btnDeleteSelected.jpg"
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="userID" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblFoodCreditHead" ForeColor="White" runat="server" Text="Affiliate Credits"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblFoodCreditText" Text='<% # "$" + Eval("Gained") + " CAD"%>'
                                    ...
                                    <asp:TemplateField HeaderText="Amount" ItemStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:RangeValidator runat="server" ID="rxFoodCredit" ValidationGroup='<% # "user"+Eval("userID") %>' ControlToValidate="txtFoodCredit"
                                                Type="Currency" ErrorMessage="Value must be numeric." MinimumValue="-999999999" MaximumValue="999999999"
                                                Display="None"></asp:RangeValidator>
                                            <cc2:ValidatorCalloutExtender ID="vceFoodCredit" runat="server" TargetControlID="rxFoodCredit">
                                            </cc2:ValidatorCalloutExtender>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Send Amount" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
