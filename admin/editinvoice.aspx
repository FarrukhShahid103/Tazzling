<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editinvoice.aspx.cs" Inherits="editinvoice" %>
        ...
        <ContentTemplate>
            ...
            <div id="pagezone">
                <div style="clear: both; padding-top: 40px;">
                    ...
                    <asp:Literal ID="ltDealsOrderDetail" runat="server" Text=""></asp:Literal>
                    <div style="width: 100%; border-bottom: 1px solid black; clear: both;">
                    </div>
                    <div style="width: 100%; clear: both; font-size: 16px; padding-top: 20px; padding-left: 15px;
                        font-weight: bold;">
                    ...
                    <div style="width: 100%; clear: both; font-size: 16px; padding-top: 10px; padding-left: 15px;">
                        <div style="float: left; padding-left: 15px;">
                            <asp:ImageButton ID="btnSendFistPayment" runat="server" ImageUrl="~/admin/Images/BtnSendFirstPayment.png"
