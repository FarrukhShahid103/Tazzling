<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="paymentDue.aspx.cs" Inherits="paymentDue" Title="TastyGo | Admin | Payment Due" %>
                    ...
                    <asp:UpdatePanel ID="upItems" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <asp:GridView ID="gvViewDeals" runat="server" DataKeyNames="dealId" Width="100%"
                                AllowSorting="False" AllowPaging="true" OnPageIndexChanging="gvViewDeals_PageIndexChanging"
                                OnRowCommand="gvViewDeals_Login" AutoGenerateColumns="False" ShowHeader="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Business Name" ItemStyle-Width="150px">
                                     ...
                                     <asp:TemplateField HeaderText="Payment Due" ItemStyle-Width="100px">
                                        <ItemTemplate>
                                             <asp:Label ID="lblPaymentDue" CssClass="fontStyle" runat="server" ForeColor="Black"
                                                Text='<%# Eval("Invoice").ToString()=="0"? "1st Payment":"$"+Eval("InvoicePayment")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                   
                                    <asp:TemplateField HeaderText="1st Invoice">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hl1stInvoice" runat="server" Target="_blank" ToolTip="View 1st Invoice"
                                                ...
                                                ImageUrl='<%# Eval("Invoice").ToString()=="0"? "~/admin/Images/duepayment.gif":"~/admin/Images/invoice.png" %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="2nd Invoice">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hl2ndInvoice" runat="server" Target="_blank" ToolTip="View 2nd Invoice"
                                                ...
                                                ImageUrl='<%# Eval("Invoice").ToString().Trim()=="1st"? "~/admin/Images/duepayment.gif":"~/admin/Images/invoice.png" %>' Visible='<%# GetStatus(Eval("Invoice"),"2")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="3rd Invoice">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hl3rdInvoice" runat="server" Target="_blank" ToolTip="View 3rd Invoice"
                                                ...
                                                ImageUrl='<%# Eval("Invoice").ToString().Trim()=="2nd"? "~/admin/Images/duepayment.gif":"~/admin/Images/invoice.png" %>' Visible='<%# GetStatus(Eval("Invoice"),"3")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>                                   
