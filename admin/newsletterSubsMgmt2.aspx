<%@ Page Title="TastyGo | Admin | Manage Newsletter Subscribers" Language="C#" MasterPageFile="~/admin/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="newsletterSubsMgmt2.aspx.cs" Inherits="admin_newsletterSubsMgmt2" %>
                                        ...
                                        <table id="tblRestuarant" border="0" cellpadding="3" cellspacing="2" width="720px"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="colLeft" width="595px">
                                                    <asp:TextBox ID="txtSubscriberEmail" runat="server" onblur="this.value=removeSpaces(this.value);"
                                                        TextMode="MultiLine" Height="100px" CssClass="txtForm" Visible="false"></asp:TextBox>
                                                    ...
                                                    <cc1:RegularExpressionValidator ID="reEmail" ValidationGroup="userSend" ControlToValidate="txtSubscriberEmail"
                                                        ErrorMessage="Please use '';'' or '','' or '''*' for separator.<br>e.g. abc@abc.com;&nbsp;<br>e.g. abc@abc.com,&nbsp;<br />or abc@xyz.com,abc@abc.com;abc.zzz.com*"
                                                        SetFocusOnError="true" Display="None" runat="server" ValidationExpression="(\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*([;,*]))*"></cc1:RegularExpressionValidator>
