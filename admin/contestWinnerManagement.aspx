<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="contestWinnerManagement.aspx.cs" Inherits="contestWinnerManagement" Title="TastyGo | Admin | Contest Winner Management" %>
    ...
    <asp:UpdatePanel ID="upGrid" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">                   
                    <div class="heading">
                        <asp:Label ID="lblCityNameSearch" runat="server" Text="Contest Title"></asp:Label>
                    </div>
                    <div>
                ...
                <div id="gv">
                    ...
                    <asp:UpdatePanel ID="gvUpdatepannel" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="contestWinner_ID" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" value='<% # Eval("contestWinner_ID") %>' ID="RowLevelCheckBox"
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <div style="display: none">
                                                <asp:Label ID="lblID1" runat="server" Text='<% # Eval("contestWinner_ID") %>' Visible="true"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                        <ItemStyle Width="2%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lblcontestWinnerTitleHead" ForeColor="White" runat="server" Text="Contest Title"
                                                CommandName="Sort" CommandArgument="contestWinner_Title"></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblContestTitleText" Text='<% # Eval("contestWinner_Title") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblDealStartTimeText" Text='<%# Eval("contestWinner_startTime").ToString().Trim()==""?"":Convert.ToDateTime(Eval("contestWinner_startTime")).ToString("MM-dd-yyyy")%>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                  <%--  <asp:TemplateField ItemStyle-Width="15%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblDealEndTimeText" Text='<%# Eval("contestWinner_endTime").ToString().Trim()==""?"": Convert.ToDateTime(Eval("contestWinner_endTime")).ToString("MM-dd-yyyy")%>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    <asp:TemplateField ItemStyle-Width="25%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblDealLinkTitle" ForeColor="White" runat="server" Text="Winner Name"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblDealLinkText" Text='<%# Eval("contestWinner_Name") %>' runat="server"></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                 
                    ...
                    <div id="popup">
                        <div id="popHeader">
                            <div style="float: left">
                                <asp:Label ID="lblpopHead" Text="Contest Winner Managment" runat="server"></asp:Label>
                            </div>
                        </div>
                        <table border="0" cellpadding="3" cellspacing="2" width="920px" class="fontStyle">
                            <tr id="trErrorMsg" runat="server" visible="false">
                                ...
                                <td align="right" class="colRight">
                                    <div class="clear" style="padding-top: 15px; padding-bottom: 20px; width: 100%" align="center">
                                        ...
                                        <div class="floatLeft">
                                            <asp:Label ID="lblErrorMsg" runat="server" Text="Contest with this name already exists"
                            ...
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="lblCityName" runat="server" Text="Contest Winner Name" />
                                </td>
                                <td align="left" class="colLeft">
                                    <asp:TextBox ID="txtContestWinnerName" runat="server" CssClass="txtForm" MaxLength="150"></asp:TextBox>
                                    <cc1:RequiredFieldValidator ID="rfvCity" runat="server" ControlToValidate="txtContestWinnerName"
                                        Display="None" ErrorMessage="<span id='cMessage'>Contest Winner Name required!.</span>"
                            ...
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="Label1" runat="server" Text="Contest Title" />
                                </td>
                                <td align="left" class="colLeft">
                                    <asp:TextBox ID="txtContestTitle" runat="server" TextMode="MultiLine" Height="50px"
                                        CssClass="txtForm" MaxLength="500"></asp:TextBox>
                                    <cc1:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtContestTitle"
                                        Display="None" ErrorMessage="<span id='cMessage'>Contest title required!.</span>"
                                        ValidationGroup="city" SetFocusOnError="True"></cc1:RequiredFieldValidator>
                         ...
                         <%--   <tr>
                            ...
                            <tr>
                                <td align="right" class="colRight">
                                    <asp:Label ID="Label3" runat="server" Text="Contest Prize Image" />
                                </td>
                                <td align="left" class="colLeft">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:FileUpload ID="fuContestImage1" runat="server" CssClass="txtForm" Width="313px" />
                                            ...
                                            <cc1:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="ImageValidation"
                                                ControlToValidate="fuContestImage1" Display="None" ErrorMessage="Invalid file format."
