<%@ Page Language="C#" MasterPageFile="~/admin/adminTastyGo.master" AutoEventWireup="true"
    CodeFile="dealInvoice.aspx.cs" Inherits="dealInvoice" Title="TastyGo | Admin | Deal Invoice" %>
                ...
                <div id="divSrchFields" runat="server">
                    <div id="searchBig">
                        <div style="clear: both;">
                            ...
                            <div style="float: left; padding-left: 10px; padding-right: 5px;">
                                <asp:DropDownList ID="ddlSearchStatus" runat="server">
                                    ...
                                    <asp:ListItem Value="expired" Text="Expired Deals" Selected="True"></asp:ListItem>
                        ...
                        <div style="clear: both; padding-top:5px;">
                            ...
                            <div style="float: left; padding-left: 10px; padding-right: 5px;">
                                <asp:DropDownList ID="ddlSearchPayment" runat="server">
                    ...
                    <asp:UpdatePanel ID="upItems" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <asp:GridView ID="gvViewDeals" runat="server" DataKeyNames="dealId" Width="100%"
                                AllowSorting="False" AllowPaging="true" ForeColor="Black" OnRowDataBound="gvViewDeals_RowDataBound"
                                ...
                                <RowStyle CssClass="gridText" HorizontalAlign="Center" ForeColor="Black" />
                                <AlternatingRowStyle CssClass="AltgridText" HorizontalAlign="Center" ForeColor="Black" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Start Date" ItemStyle-Width="90px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStartDate" CssClass="fontStyle" ForeColor="Black" runat="server"
                                                Text='<% # Eval("dealStartTime")!=DBNull.Value? Convert.ToDateTime(Eval("dealStartTime")).ToString("MM-dd-yyyy"): "" %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="End Date" ItemStyle-Width="90px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEndDate" CssClass="fontStyle" runat="server" ForeColor="Black"
                                                Text='<% # Eval("dealEndTime")!=DBNull.Value? Convert.ToDateTime(Eval("dealEndTime")).ToString("MM-dd-yyyy"): "" %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Deal Title" ItemStyle-Width="300px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblItemName" CssClass="fontStyle" runat="server" ForeColor="Black"
                                                Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "title").ToString()) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Business Name" ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblResName" CssClass="fontStyle" runat="server" ForeColor="Black"
                                                Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "restaurantBusinessName").ToString()) %>'>
                                            </asp:Label>                                            
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Successful Orders">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlEditDeals" runat="server" Target="_blank" ToolTip="View successful orders"
                                                Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "SuccessfulOrder").ToString()) %>'
                                                NavigateUrl='<%# "orders.aspx?order=success&did="+ Eval("dealid") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Void Orders">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hlcancelorders" runat="server" Target="_blank" ToolTip="View cancel or refunded orders"
                                                Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "CancelledOrder").ToString()) %>'
                                                NavigateUrl='<%# "orders.aspx?order=cancel&did="+ Eval("dealid") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="1st Invoice">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hl1stInvoice" runat="server" Target="_blank" ToolTip="View 1st Invoice"
                                                NavigateUrl='<%# "editinvoice.aspx?myname=colinazam&invoicetype=1st&did="+ Eval("dealid") %>'
                                                ImageUrl="~/admin/Images/invoice.png" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="2nd Invoice">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hl2ndInvoice" runat="server" Target="_blank" ToolTip="View 2nd Invoice"
                                                NavigateUrl='<%# "editinvoice2.aspx?myname=colinazam&invoicetype=2nd&did="+ Eval("dealid") %>'
                                                ImageUrl="~/admin/Images/invoice.png" Visible='<%# GetStatus(Eval("Invoice"),"2")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="3rd Invoice">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hl3rdInvoice" runat="server" Target="_blank" ToolTip="View 3rd Invoice"
                                                NavigateUrl='<%# "editinvoice3.aspx?myname=colinazam&invoicetype=3rd&did="+ Eval("dealid") %>'
                                                ImageUrl="~/admin/Images/invoice.png" Visible='<%# GetStatus(Eval("Invoice"),"3")%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
