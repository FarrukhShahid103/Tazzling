<%@ Page Title="TastyGo | Admin | Sub Category Managment" Language="C#" MasterPageFile="~/admin/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="subcategoriesManagement.aspx.cs" Inherits="subcategoriesManagement" %>
    ...
    <asp:UpdatePanel ID="upGrid" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                <div id="search">
                    <div class="heading">
                        <asp:Label ID="lblCousineNameSearch" runat="server" Text="Sub Category Name"></asp:Label>
                    </div>
                    <div>
                ...
                <div class="searchButtons">
                    ...
                    <div class="floatLeft">
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/admin/images/btnBack.gif"
                            OnClientClick="document.location.href='categoriesManagement.aspx'" />&nbsp;
                    </div>
                    <div class="floatLeft">
                            ...
                            <asp:GridView ID="pageGrid" runat="server" DataKeyNames="categoryId" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <div>
                                                <asp:Label ID="lblParentcategoryNameText" Text='<% # Eval("categoryParentname") %>'
                                  ...
                                  <%--  <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblcategoryviewSubHead" ForeColor="White" runat="server" Text="View Sub Subcategories"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
                                                <asp:HyperLink ID="hlView" runat="server" ImageUrl="~/admin/Images/view_icon.gif"
                                                    NavigateUrl='<% # "~/admin/subsubcategoriesManagement.aspx?vscid="+Eval("categoryId") %>' />
                                            </div>
                                        </ItemTemplate>
                                    </asp:Templa    teField>--%>
                                   <%-- <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <HeaderTemplate>
                                            <asp:Label ID="lblcategoryAddNewHead" ForeColor="White" runat="server" Text="Add New Sub Subcategory"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div>
