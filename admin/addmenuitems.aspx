<%@ Page Title="TastyGo | Admin | Menu Items" Language="C#" MasterPageFile="~/admin/adminTastyGo.master"
    AutoEventWireup="true" CodeFile="addmenuitems.aspx.cs" Inherits="addmenuitems"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateFields(txtItemName, txtItemDesc, txtItemSubName, txtItemPrice) {
                    ...
                    <asp:UpdatePanel ID="upItems" runat="server">
                        <ContentTemplate>
                            <asp:DataGrid ID="gridViewMenus" runat="server" Width="100%" AllowSorting="False"
                                ...
                                OnCancelCommand="gridViewMenus_CancelCommand" OnEditCommand="gridViewMenus_EditCommand"
                                OnUpdateCommand="gridViewMenus_UpdateCommand" OnItemDataBound="gridViewMenus_ItemDataBound"
                                                                                        ...
                                                                                        <asp:DataGrid ID="gridViewItems" runat="server" AllowPaging="False" AllowSorting="False"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateColumn HeaderText="Item Price">
                                                                                                    <FooterTemplate>
                                                                                                        <asp:TextBox ID="txtAddItemPrice" Width="80px" MaxLength="50" CssClass="txtForm"
                                                                                                            runat="server"></asp:TextBox>
                                                                                                    </FooterTemplate>
                                                                                                    <ItemTemplate>
                                                                                                    ...
                                                                                                    <EditItemTemplate>
                                                                                                        <asp:TextBox ID="txtUpdateItemPrice" runat="server" Width="80px" CssClass="txtForm"
                                                                                                            MaxLength="50" Text='<%# DataBinder.Eval (Container.DataItem, "itemPrice") %>'
                                                                                                            TextMode="SingleLine">
                                                                                                        </asp:TextBox>
                                                                                                    </EditItemTemplate>
                                                                                                </asp:TemplateColumn>
                                                                                                <asp:TemplateColumn HeaderText="Action">
                                                                                                    <FooterTemplate>
                                                                                                        <div align="right" style="padding-right: 15px;">
                                                                                                            <asp:ImageButton ID="btnAddMenuItem" CommandName="AddItem" CommandArgument='<%# DataBinder.Eval (Container.DataItem, "foodTypeID") %>'
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        ...
                                                                                                        <asp:LinkButton ID="lnkBtnSubMenuItem" runat="server" Text="SubMenu" PostBackUrl='<%# "~/admin/subMenu.aspx?MID="+ Eval("menuItemId") %>'></asp:LinkButton>
                                                                                                    </ItemTemplate>
                                                                                                    <EditItemTemplate>
